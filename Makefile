...
MODULES=ast type lexer common genxml parser typecore optimizer typeload \
	...
	genswf9 genswf genjava gencs genpy genrb interp dce filters typer matcher version main
...
genrb.$(MODULE_EXT): type.$(MODULE_EXT) lexer.$(MODULE_EXT) common.$(MODULE_EXT) codegen.$(MODULE_EXT) ast.$(MODULE_EXT)
